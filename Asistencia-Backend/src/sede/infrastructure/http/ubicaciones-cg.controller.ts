...
import { UbicacionesCGService } from 'src/sede/application/ubicaciones-cg.service';

@Controller('ubicaciones')
export class UbicacionesCGController {
  constructor(private readonly service: UbicacionesCGService) {}
