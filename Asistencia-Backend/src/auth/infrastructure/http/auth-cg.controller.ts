...
export class AuthCGController {
  ...
  @Roles('admin')
  @Post('register-admin')
  registerAdmin(@Req() req: any, @Body() body: any) {
    // Un admin solo puede registrar usuarios en su propia sede.
    return this.authService.register({ ...body, tenantSlug: req.user.tenantSlug });
  }
