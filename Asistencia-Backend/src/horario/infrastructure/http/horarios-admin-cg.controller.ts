...
import { HorariosAdminCGService } from 'src/horario/application/horarios-admin-cg.service';

@Controller('horarios-admin')
export class HorariosAdminCGController {
  constructor(private readonly horariosAdminService: HorariosAdminCGService) {}
