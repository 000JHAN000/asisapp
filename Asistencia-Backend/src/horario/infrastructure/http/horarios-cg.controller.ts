...
import { HorariosCGService } from 'src/horario/application/horarios-cg.service';

@Controller('horarios')
export class HorariosCGController {
  constructor(private readonly service: HorariosCGService) {}
