...
export class AppLayoutComponent implements OnDestroy {
  ...
  navItems = computed(() => {
    ...
    if (r === 'admin') return [
      ...
      { icon: 'clipboard-list', label: 'Asistencia', path: '/app/admin/asistencia-historial' },
      { icon: 'upload', label: 'Registro Masivo', path: '/app/admin/registro-masivo' },
    ...
    if (r === 'instructor') return [
      ...
      { icon: 'clipboard-list', label: 'Gestión de Asistencia', path: '/app/instructor/asistencia' },
    ...
    return [
      ...
      { icon: 'scan-face', label: 'Registro Facial', path: '/app/aprendiz/registro-facial' },
      { icon: 'check-circle', label: 'Asistencia', path: '/app/aprendiz/asistencia' },
    ];
  });
