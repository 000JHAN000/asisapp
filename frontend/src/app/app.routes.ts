      ...
      // Admin
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import('./features/horarios/admin/horarios.component').then((m) => m.AdminHorariosComponent),
            data: { tab: 'instructor' }
          },
          {
          ...
          },
          {
            ...
            loadComponent: () =>
              import('./features/asistencias/admin/admin-asistencia-historial.component').then((m) => m.AdminAsistenciaHistorialComponent),
          },
          {
            path: 'registro-masivo',
            loadComponent: () =>
              import('./features/admin/registro-masivo/admin-registro-masivo.component').then((m) => m.AdminRegistroMasivoComponent),
          },
        ],
      },
      // Instructor
      {
        ...
        children: [
          ...
          },
          {
            path: 'mis-horarios',
            loadComponent: () =>
              import('./features/horarios/instructor/mis-horarios.component').then((m) => m.InstructorMisHorariosComponent),
          },
          {
            path: 'solicitudes',
            loadComponent: () =>
          ...
          },
          {
            path: 'asistencia',
            loadComponent: () =>
              import('./features/asistencias/instructor/instructor-asistencia.component').then((m) => m.InstructorAsistenciaComponent),
          },
        ],
      },
      // Aprendiz
      {
        ...
        children: [
          ...
          },
          {
            path: 'mis-horarios',
            loadComponent: () =>
              import('./features/horarios/aprendiz/aprendiz-mis-horarios.component').then((m) => m.AprendizMisHorariosComponent),
          },
          {
            path: 'asistencia',
            loadComponent: () =>
              import('./features/asistencias/aprendiz/aprendiz-firma.component').then((m) => m.AprendizFirmaComponent),
          },
          {
            path: 'registro-facial',
            loadComponent: () =>
              import('./features/aprendiz/registro-facial/aprendiz-registro-facial.component').then((m) => m.AprendizRegistroFacialComponent),
          },
        ],
      },
