...
export class ApiService {
  ...
  getAmbientesDisponibilidad(dia: string, jornada: string) {
    return this.http.get<any[]>(`${BASE}/ambientes/disponibilidad?dia=${dia}&jornada=${jornada}`);
  }
  ...
  getHorariosByInstructor(id: string | number) { return this.http.get<any[]>(`${BASE}/horarios/by-instructor/${id}`); }
  getHorariosByFicha(id: string | number) { return this.http.get<any[]>(`${BASE}/horarios/by-ficha/${id}`); }
  ...
  getCompetenciasByHorario(id: string | number) { return this.http.get<any[]>(`${BASE}/competencias/horario/${id}`); }
  getCompetenciasByInstructor(id: string | number) { return this.http.get<any[]>(`${BASE}/competencias/instructor/${id}`); }
  ...
  getSolicitudesByInstructor(id: string | number) {
  ...
  getNotificaciones(destinatarioId: string | number, destinatarioRol: string) {
  ...
  // ── Ubicaciones (horarios_db) ─────────────────────────────────
  getUbicaciones() { return this.http.get<any[]>(`${BASE}/ubicaciones`); }
  getUbicacionesTipos() { return this.http.get<string[]>(`${BASE}/ubicaciones/tipos`); }
  getUbicacionesPorTipo(tipo: string) { return this.http.get<any[]>(`${BASE}/ubicaciones?tipo=${tipo}`); }
  getUbicacionesDisponiblesTransversal(tipo: string, dia: string, jornada: string) {
    return this.http.get<any[]>(`${BASE}/ubicaciones/disponibles-transversal?tipo=${encodeURIComponent(tipo)}&dia=${dia}&jornada=${jornada}`);
  }
  createUbicacion(d: any) { return this.http.post(`${BASE}/ubicaciones`, d); }
  updateUbicacion(id: number, d: any) { return this.http.put(`${BASE}/ubicaciones/${id}`, d); }
  deleteUbicacion(id: number) { return this.http.delete(`${BASE}/ubicaciones/${id}`); }
